 ...
 */
public class Permissions_in2 extends ExpandableListActivity implements Runnable {
    ...
    public void run() {                                                               // 3.  쓰레드 동작
        ...
        Collections.sort(mGroupData, new Comparator<Map<String, String>>() {
            @Override
            public int compare(Map<String, String> first, Map<String, String> second) {

                return first.get("Securitylevel").compareTo(second.get("Securitylevel"));
            }
        });
        Collections.sort(mChildData, new Comparator<List<Map<String, String>>>() {
            @Override
            public int compare(List<Map<String, String>> first, List<Map<String, String>> second) {

                return first.get(0).get("Securitylevel").compareTo(second.get(0).get("Securitylevel"));
            }
        });
